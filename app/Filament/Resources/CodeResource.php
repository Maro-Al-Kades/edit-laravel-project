...
class CodeResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'كود دولة';
    protected static ?string $recordTitleAttribute = 'name';
    protected static ?string $pluralModelLabel = 'أكواد الدول';
    protected static ?string $navigationLabel = 'أكواد الدول';

    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                TextInput::make('name')->label('كود الدولة')->extraAttributes(['dir' => 'ltr'])
            ]);
    }
